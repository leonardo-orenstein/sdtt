...
class SimulationVehicle(object):
    ...
    '''
    def __init__(self, theta_0 = 0.0, x_0 = 0.0, y_0 = 0.0,  acc = 1.0, v = 0.0):
        self.x = x_0
        self.y = y_0
        ...
        self.errorPos = 0.0 # in meters
        self.errorOrientation = 0.0 # in radians
        self.errorVelocity = 0.0 # in percents
...
class Bike(SimulationVehicle):
    def __init__(self,
                 theta_0 = 0.0, x_0 = 0.0, y_0 = 0.0,
                 acc = 1.0, dPhi = 1.0*pi/180.0, v = 0.0, phi = 0.0,
                 length = 2.0, tailDistance = 0.5):
...
class BikeTrailer(object):
    def __init__(self, theta = 0.0, x_0 = 0.0, y_0 = 0.0, lengthTractor = 4.0, lengthTrailer = 10.0, tailDistance = 0.5):
